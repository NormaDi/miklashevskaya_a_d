...
//каким свойствои должна обладать операция копирования? - ответ: новый экземпляр должен быть копия становится с тем же значением что и оригинал.
//между копией и оригиналом  не возникло какой-нибудь неявной связи. После того как произвели копирование оригинал не изменился
//
